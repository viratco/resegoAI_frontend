          ...
          {steps.map((step, index) => (
            <div key={step.title} className="relative">
              <div className="flex items-start gap-8 mb-12">
                <div className="animate-on-scroll opacity-0 shrink-0" data-animation="fade-in-left">
                ...
                <div className="flex-1 animate-on-scroll opacity-0" data-animation="fade-in-right">
                  <div className="bg-white p-8 rounded-xl shadow-lg border border-[#E5DEFF]">
              ...
              {index < steps.length - 1 && (
                <div className="absolute left-10 ml-[-4px] h-16 flex items-center justify-center">
